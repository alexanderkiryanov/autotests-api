...
login_payload = {
  "email": "sp-br@gmail.com",
  "password": "Winoforce_15"
}
...
refresh_response = httpx.post("http://localhost:8000/api/v1/authentication/refresh",
                              json=refresh_payload)
refresh_response_data = refresh_response.json()

print(f"Refresh token response: ", refresh_response.json())
